...
const AttractScreen: React.FC = () => {
  ...
  // Straight into the menu: "para aquí o para llevar" and the call-out name are
  // asked at the END of the flow (cart → fulfillment → name → pay). Food first —
  // the logistics questions mean more once there's an order to attach them to,
