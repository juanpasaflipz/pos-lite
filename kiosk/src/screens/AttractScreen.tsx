  ...
  return (
    <div className="relative h-full w-full">
      ...
      >
        ...
        {/* Fixed 96px was tablet-only — on a phone that either clips off the
            top/bottom of the screen (html/body use overflow:hidden) or forces
            multi-line wraps that push the tap circle off-screen. Scale down
            through the phone/small-tablet range, keep the original size from
            lg (1024px) up where the tablet kiosk actually lives. */}
