    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-neutral-800">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-cockpit-green flex items-center justify-center">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {success ? (
            <div className="text-center space-y-6">
              ...
              <button
                onClick={() => navigate('/')}
                className="px-6 py-3 bg-cockpit-green text-white font-semibold rounded-lg hover:bg-cockpit-green/90 transition-colors"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-neutral-900 border border-neutral-700 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:border-cockpit-green"
                    autoFocus
                    disabled={!token}
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-cockpit-green text-white font-semibold rounded-lg hover:bg-cockpit-green/90 transition-colors disabled:opacity-50"
                >
