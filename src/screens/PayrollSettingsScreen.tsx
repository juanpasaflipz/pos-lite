...
export default function PayrollSettingsScreen() {
  ...
  // Edit buffers per employee — keyed by employee_id.
  ...
  if (loading || !settings) {
    return (
      <div className="min-h-screen bg-neutral-950 p-6">
        <div className="h-24 bg-neutral-900 rounded-lg border border-neutral-800 animate-pulse" />
      </div>
    );
  }
      ...
      <div className="bg-neutral-900 text-white p-6 border-b border-neutral-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-black tracking-tighter">{t('payroll.title')}</h1>
          </div>
