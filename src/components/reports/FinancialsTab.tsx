        ...
        {editingTargets && (
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 bg-cockpit-green text-white rounded-lg hover:bg-cockpit-green/90 transition-colors min-h-[44px] disabled:opacity-50"
            >
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            {actualDraft[row.category] !== undefined && (
                              <button
                                ...
                                className="px-2 py-1 text-xs bg-cockpit-green text-white rounded hover:bg-cockpit-green/90 disabled:opacity-50"
                              >
