        ...
        {modalState === 'success' && issuedInvoice && (
          <div className="p-4 space-y-4">
            <div className="flex flex-col items-center gap-2 py-2">
              ...
              <p className="text-cockpit-in-text font-bold text-sm">{t('invoice.success')}</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              {invoiceTokenUrl && (
                ...
                >
                  {copied ? (
                    <>
                      <Check className="w-4 h-4 text-cockpit-in-text" />
                      <span className="text-cockpit-in-text">{t('invoice.linkCopied')}</span>
                    </>
                  ) : (
                    <>
        ...
        {modalState === 'error' && (
          <div className="p-4 space-y-4">
            <div className="flex flex-col items-center gap-2 py-2">
              ...
              <p className="text-cockpit-out-text font-bold text-sm">{t('invoice.errorTitle')}</p>
            </div>

            <div className="bg-cockpit-red/20 border border-cockpit-red rounded-lg p-3">
              <p className="text-cockpit-out-text text-sm">{errorMessage}</p>
            </div>
