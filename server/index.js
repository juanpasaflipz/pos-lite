...
import externalTerminalsRoutes from './routes/external-terminals.js';
...
import prepRunsRoutes from './routes/prep-runs.js';
...
app.use('/api/external-terminals', externalTerminalsRoutes);
...
app.use('/api/prep-runs', prepRunsRoutes);
